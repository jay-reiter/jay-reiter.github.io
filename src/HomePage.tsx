...
import ResumeCard, { ResumeCardGroup } from "./components/ResumeCard";
    ...
    <Box my={3} display='flex' justifyContent='center' flexDirection='column'>
      ...
      <Box>
        ...
        <Typography variant='body1'>
          ...
          there's a lot to do, so not all the pages are currently filled out. Of
          course, if there's anything you want to know more about, I am more
      ...
      <ResumeCardGroup
        ...
        cards={[
          <ResumeCard
            ...
            description={
              <>
                ...
                arithmetic with p-adic numbers, evaluate p-adic power series to
                arbitrary precision, and then represent them graphically
                (pictured above).
                <br />
                <br />
          ...
          <ResumeCard
            ...
            description={
              <>
                I decided to make this website to share some of the things I've
                done that don't quite fit or belong on my resume. Everything
                from big coding projects and research papers to math problems I
                thought were cool, me playing cello, and little JavaScript games
                I've built will be on here!
                <br />
          ...
          <ResumeCard
            ...
            description={
              <>
                This is a project with Design for America UIUC and the Illinois
                Public Health Insitute (IPHI) to build a website that provides
                breastfeeding mothers in Illinois with a list of accessible
                resources to help them both during pregnancy and in the first
                year of parenting. Our focus is particularly on marginalized
                groups of mothers such as mothers of color, teenage mothers, and
                rural mothers, that may not have easy access to the information,
                resources, or cultural support they need to breastfeed their
                children healthfully and stress-free.
                <br />
                <br />
                ...
                <Box my={2}>
                  <Grid container justifyContent='space-around'>
                    ...
                    >
                      ...
                      lactation consultants) in order to alleviate common fears
                      and boost self esteem?
                    </Grid>
                  </Grid>
                </Box>
                <Typography variant='h5'>
                  Here are some wire frames of the website we've created so far:
                </Typography>
                <Box display='flex' py={2} justifyContent='center' width='100%'>
