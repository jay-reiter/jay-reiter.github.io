  ...
  return (
    <PageBase>
      <ContentBlock>
        ...
        <Typography level='h3' gutterBottom color='primary' fontWeight='300'>
          Expository
        </Typography>
        <List>
          <ListItem>
            <WritingItem
              ...
              date='October 2025'
            >
              Some "users' guide" notes which I made to record some key facts
              which come up "in practice." One of my main goals making these was
              to understand{" "}
              <MathComponent tex={String.raw`\infty`} display={false} />
              -categorical localizations,{" "}
              <MathComponent tex={String.raw`\mathsf{Pr}^L`} display={false} />,
              and hypercomplete objects. Another was to have a quick reference
              for things like the existence of adjoint functors,
              representability criteria, etc.
            </WritingItem>
          </ListItem>
          <ListItem>
            <WritingItem
            ...
            >
              ...
              includes some background on formal groups and stacks. This was
              written to fulfill the second year "writing milestone" requirement
              for Ph.D. students at UW.
            </WritingItem>
          </ListItem>
        </List>
      </ContentBlock>
